...
const TermsOfService: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms of Service - Tickipop</title>
        <meta name="description" content="Terms of Service for www.tickipop.com - Learn about the rules and guidelines for using our service." />
        <meta name="keywords" content="terms of service, tickipop, user agreement, legal terms, service conditions" />
        <link rel="canonical" href="https://www.tickipop.com/terms" />
      </Helmet>
